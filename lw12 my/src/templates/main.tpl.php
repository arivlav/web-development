...
{
    $selected = '';
    if (isset($form['country']) && $form['country'] == $key) $selected = 'selected';
    ...
    <div class="form__inside">  
      <form method="post" action="index.php">
        ...
        <div class="form__section">  
          ...
          <?php if (isset($errors['name']) && $errors['name'] != '') echo '<span class="form__error">'.$errors['name'].'</span>';?>
        </div>  
        <div class="form__section">  
          ...
          <?php if (isset($errors['email']) && $errors['email'] != '') echo '<span class="form__error">'.$errors['email'].'</span>';?>
        </div>  
        <div class="form__section">  
        ...
        <div class="form__section_radio">  
          <label for="male"  class="form__label_radio">
            <input type="radio" name="gender" value="male" id="male"  <?php if (isset($form['gender']) && $form['gender'] == 'female') echo 'checked';?>>
            Мужской
          </label>
          <label for="female" class="form__label_radio">
            <input type="radio" name="gender" value="female" id="female" <?php if (isset($form['gender']) && $form['gender'] == 'female') echo 'checked';?>>
            Женский
          </label>
        </div>  
        <div class="form__section">  
          ...
          <?php if (isset($errors['message']) && $errors['message'] != '') echo '<span class="form__error">'.$errors['message'].'</span>';?>
        </div>
